class Enemy_02 extends Sprite {
  ...
  constructor(sprite, spriteHandler) {
    ...
    this.shoots= this.spriteHandler.createSprite({
      type:"enemy_02",
      sprite: "enemy_02_shoot",
      quantity : 3,
      stage : this
    })

    this.enemy_02_explosion = this.spriteHandler.createSprite({
      type:"enemy_02",
      sprite: "enemy_02_explosion",
      quantity : 1,
      stage : this
    })


    this.explosion =  Object.values(this.enemy_02_explosion)[0];
  ...
  explode = ()=>{
    ...
    this.spriteHandler.addSpriteToGame(SpriteHandler.explosions,this.explosion)
    this.destroy();
    SoundHandler.playSound("enemy_02", "explosion");
  }
