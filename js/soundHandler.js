class SoundHandler {
  ...
  static soundTemplates = {
    "spaceship" : {
      "photonShoot": {
        "copies" : 10,
        "resource" : "../resources/sprites/spaceship_02/sounds/photonShoot.wav",
        "volume" : 0.5
      },
      "laser" : {
        "copies" : 5,
        "resource" : "../resources/sprites/spaceship_02/sounds/laser.wav",
        "volume" : 0.2
      }
    },
    "enemy_01" : {
      "explosion" : {
        "copies": 15,
        "resource" : "../resources/sprites/enemy_01/sounds/explosion.wav",
        "volume" : 0.3
      }
    }
  }
